...
\deskaFunc{resolvedObjectDataWithOrigin}{, "kindName": "kind", "objectName": "object", "revision": "r123"}
    ...
    When no object in the inheritance hierarchy provides a value for an attribute (like attribute {\tt smrt} in this
    example, the object name is reported as {\tt null}.
