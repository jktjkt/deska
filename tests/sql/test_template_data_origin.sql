...
BEGIN
	...
	PREPARE retresolved_data AS SELECT purchase, purchase_templ, warranty, warranty_templ, template_hardware FROM hardware_template_resolved_object_data_template_info('purchase_warranty_template');
	...
	PREPARE retresolved_data AS SELECT purchase, purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, template_hardware FROM hardware_template_resolved_object_data_template_info('ram_cpu_purchase_warranty_template');
	...
	PREPARE retresolved_data AS SELECT purchase, purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_template_resolved_object_data_template_info('template_all');
	...
	PREPARE retresolved_data AS SELECT vendor, vendor_templ, purchase, purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_resolved_object_data_template_info('templated_hardware_1');
	...
	PREPARE retresolved_data AS SELECT vendor, vendor_templ, purchase, purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_resolved_object_data_template_info('templated_hardware_2');
	RETURN NEXT results_eq( 'expresolved_data', 'retresolved_data', 'resolved template data of templated hardware are ok' );
	DEALLOCATE expresolved_data;
	DEALLOCATE retresolved_data;
	...
	PREPARE retresolved_data AS SELECT purchase, purchase_templ, warranty, warranty_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_template_resolved_object_data_template_info('purchase_warranty_template');
	...
	PREPARE retresolved_data AS SELECT purchase, purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_template_resolved_object_data_template_info('ram_cpu_purchase_warranty_template');
	RETURN NEXT results_eq( 'expresolved_data', 'retresolved_data', 'resolved template data of hardware_template after change in template are ok' );
	DEALLOCATE expresolved_data;
	DEALLOCATE retresolved_data;
	...
	PREPARE retresolved_data AS SELECT vendor, purchase,purchase_templ, warranty, warranty_templ, ram, ram_templ, cpu_num, cpu_num_templ, note_hardware, note_hardware_templ, template_hardware FROM hardware_resolved_object_data_template_info('templated_hardware_2');
