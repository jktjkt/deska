SET search_path TO jsn,api,genproc,history,deska,versioning,production;
...
SELECT setAttribute('hardware','hwDELL','note_hardware','cesky text v repozitari');
...
SELECT setAttribute('hardware','hwDELL','note_hardware','test');
