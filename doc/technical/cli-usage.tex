...
\todo{Tomas: write some intro here}
...
When you would like to connect to your changeset again, you should use command {\rr resume}. This command will show
...
\todo {Fix these ugly tables}

\begin{longtable}{ l | l | l | l |  p{5cm} | l }
