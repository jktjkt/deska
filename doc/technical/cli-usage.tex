...
The second filter is for obtaining last added embedded object using keyword {\tt new}. The usage is the same as in case of
{\tt all}. We will describe usage of both keywords later.
...
parameter for {\tt rename} is the same as for create, but you have to specify the new name as the last word. For example
