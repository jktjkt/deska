...
class Table(constants.Templates):
	...
	def gen_del_embed(self, ref_col, ref_table):
		return self.del_embed_string.format(tbl = self.name, delim = constants.DELIMITER, refcolumn = ref_col, reftbl = ref_table)
