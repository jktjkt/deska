...
in~\secref{sec:objects-and-relations}.
...
(\secref{sec:relation-refers-to}), defining default values through template inheritance
(\secref{sec:relation-templatized}) or object composition (\secref{sec:relation-contains}) to implementing a tree-like
hierarchy of objects on top of the flat namespace (\secref{sec:relation-embed-into}).
