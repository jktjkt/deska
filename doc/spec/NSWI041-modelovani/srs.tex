...
This section lists all of the detailed requirements for the versioning storage susbsystem.
...
\begin{table}[!h]
	\begin{tabular}{| l | l |}
		...
		\textbf{Req. Code} & \textbf{Requirement Description}\\
		\hline
        H8-5    &   Providing a well arranged view on the managed infrastructure\\
		\hline
        H9-6    &   Generating graphs depicting interesting performance and availability
