...
CREATE FUNCTION box_not_in_cycle(box_uid bigint, inside_uid bigint)
RETURNS BOOLEAN
AS
$$
BEGIN
...
ALTER TABLE box ADD CONSTRAINT box_chck_inside CHECK (box_not_in_cycle(uid, inside));
