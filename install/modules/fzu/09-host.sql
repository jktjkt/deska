...
CREATE TABLE host (
	...
	hardware bigint
		-- merge / contains
		CONSTRAINT rcont_host_fk_hardware REFERENCES hardware(uid) DEFERRABLE,
	virtual_hardware bigint
		-- merge / contains
		CONSTRAINT rcont_host_fk_virtual_hardware REFERENCES virtual_hardware(uid) DEFERRABLE,
