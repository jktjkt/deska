...
\deskaFunc{showConfigDiff}{, "forceRegen": true}
    ...
    If the {\tt forceRegen} attribute is present and {\tt true}, the server will forcefully discard its pre-cached copy
    of the configuration output, and will generate a fresh one.}
