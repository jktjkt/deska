...
important pieces of information about a grid computing site (\secref{sec:intro}).
...
(\secref{sec:objects-and-relations}).  To our best knowledge, the existing ORM~\footnote{Object Relation Mapping}
