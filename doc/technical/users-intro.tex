...
Deska server (see \todo{Honza: add a reference when the ``user's doc'' is actually there}) which implements object
...
\todo{Honza: again, example of configdiff}
