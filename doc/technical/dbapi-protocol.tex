...
attributes, and \deskaFuncRef{resolvedObjectDataWithOrigin} as a variant of \deskaFuncRef{objectData} which natively supports
resolving inherited values from object templates.  For batched retrieval of data for multiple objects of the same kind,
use the \deskaFuncRef{multipleObjectData} and \deskaFuncRef{multipleResolvedObjectDataWithOrigin}.
...
\deskaFunc{objectData}{, "kindName": "kind", "objectName": "object", "revision": "r123"}
    ...
    performed, see \deskaFuncRef{resolvedObjectDataWithOrigin} for a function which operates on the resolved object state.
    ...
    \deskaFuncRef{multipleResolvedObjectDataWithOrigin}.  \deskaUnsortedRes
    }
