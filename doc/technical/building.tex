...
default installation of Scientific Linux 6.1, and might require adjustments on other systems.

\todo{Honza: write the script}
...
\todo{Tomas: where shall I put that file?}
