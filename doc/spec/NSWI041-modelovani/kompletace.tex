...
% How to compile the resulting huge PDF:
% pdfjoin kompletace.pdf vision.pdf srs.pdf use_cases.pdf business_process.pdf analytical_class_model.pdf function_model.pdf glossary.pdf spec.pdf ; mv spec-joined.pdf compilation.pdf
