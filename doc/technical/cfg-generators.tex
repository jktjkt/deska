...
\todo{Honza: describe the trick with the pipes}
\todo{Honza: mention that accessing stdout/stdin will break once the buffer fills (we're in the libDeskaDb and it takes
care just for the two FDs)}
\todo{Honza: maybe even redirect the stream into a peristent file to prevent that?}
...
\todo{Honza: make this much more prominent}
