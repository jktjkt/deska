...
operate on.  When the version is not specified, the implicit value is fixed at the latest persistent revision which was
committed at the time the session started.
...
FIXME: make sure the above is OK
...
\deskaFunc{startChangeset}{}
    ...
    It is an error to attempt to create a new changeset while being already attached to another one.
    }
