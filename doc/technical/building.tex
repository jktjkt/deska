...
\todo{Honza: list of the all required packages}
...
\todo{Honza: guide the user through the SSH setup here}

\subsection{Database Deployment}
\label{sec:build-database-deployment}

After the PostgreSQL server is configured properly, it is time to deploy the database scheme.
